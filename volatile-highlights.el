...
;;; Change Log:
;;
;;   - New user option `vhl/use-pulsing-visual-effect-p'. When this option has
;;     non-nil value, volatile highlights will be cleared with pulsing visual
;;     effect. This should fix #16.
;;     This user option is inspired by the library `pulse.el', which was written
;;     by Eric M. Ludlam.
;;
...
(defcustom vhl/use-pulsing-visual-effect-p t
